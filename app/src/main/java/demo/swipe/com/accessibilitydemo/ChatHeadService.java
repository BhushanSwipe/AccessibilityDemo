...
public class ChatHeadService extends Service {
    ...
    public void onCreate() {
        ...
        super.onCreate();
        Log.e("OnCreate","ChatHeadService");
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        Log.e("onTaskRemoved","ChatHeadService");
    ...
    private void handleStart() {
        ...
        removeView = (RelativeLayout) inflater.inflate(R.layout.headtail, null);
        ...
        removeImg = (ImageView) removeView.findViewById(R.id.view_remove);
        windowManager.addView(removeView, paramRemove);


        chatheadView = (RelativeLayout) inflater.inflate(R.layout.traslucent, null);
        chatheadImg = (LinearLayout) chatheadView.findViewById(R.id.price_icon);
        TextView textView = (TextView) chatheadView.findViewById(R.id.textview_save_price);
        TextView saving_price = (TextView) chatheadView.findViewById(R.id.textview_save_price);
        Log.e("product_price", "product_price" + MyApplication.product_price);
        String price = String.valueOf("" + MyApplication.saving_price);
//		String formatted_price = NumberFormat.getNumberInstance(Locale.US).format(price);
        saving_price.setText("\u20B9 "+price);
...
//        Log.e("window_width" + w, "window_height" + h);
        szWindow.set(w, h);
        //	}
        ...
        chatheadView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(getApplicationContext(),"Name="+MyApplication.getNameString+",Prc="+MyApplication.getPrice,Toast.LENGTH_SHORT).show();
                /*if (isMyServiceRunning(ChatHeadService.class)) {
                    stopSelf();
                }*/
                Intent intent = new Intent(getApplicationContext(), WebActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        ...
        chatheadView.setOnTouchListener(new View.OnTouchListener() {
            ...
            Runnable runnable_longClick = new Runnable() {
                ...
                public void run() {
                    // TODO Auto-generated method stub
                    Log.e("runnable_longClick","ChatHeadService");

                    isLongclick = true;
                    removeView.setVisibility(View.VISIBLE);
                    chatheadView.setHapticFeedbackEnabled(true);
                    chathead_longclick();
                }
            };
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                //Log.e("xcord" + x_cord, "ycord" + y_cord);
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        if (isLongclick) {
                            ...
                            /*Log.e("xcord" + x_cord, "boundxleft" + x_bound_left);
                            Log.e("boundxleft" + x_bound_right, "ycord" + y_cord);
                            Log.e("ycordtop" + y_bound_top, "yboundtop");*/
...
//        Toast.makeText(getApplicationContext(),"Name="+MyApplication.getNameString+",Prc="+MyApplication.getPrice,Toast.LENGTH_SHORT).show();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.e("onStartCommand","ChatHeadService");
    ...
    public void onDestroy() {
        // TODO Auto-generated method stub
        super.onDestroy();
        Log.e("onDestroy","ChatHeadService");
        //Log.e("destroy", "destroy");
        //Log.e("scroll", "scroll" + MyApplication.scrolling_flag);

        MyApplication.scrolling_check_false = false;
